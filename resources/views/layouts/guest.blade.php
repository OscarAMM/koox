...
<body class="d-flex flex-column vh-100" style="background-color: #ffffff">
    <div id="app" style="background-color:#ffffff">
        <nav class="navbar navbar-light navbar-expand-lg bg-light justify-content-lg-center">
            <a class="navbar-brand font-weight-bold d-md-none d-inline" href="{{route('welcome')}}"> <img src="{{asset('images/logo.png')}}" alt=""> Ko'ox Tsikbal</a>
                ...
                <ul class="navbar-nav mx-auto text-lg-center text-left">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <a class="dropdown-item" href="#" data-toggle="modal" data-target="#welcome_modal">Realiza
                                tu
                                ticket</a>
                            @endif
                        </div>
                    ...
                    <li class="nav-item my-auto">
                        <a class="nav-link navbar-brand mx-0 d-none font-weight-bold d-md-inline"
                            href="{{route('welcome')}}"><img src="{{asset('images/logo.png')}}" alt=""> Ko'ox
                            Tsikbal</a>
                    </li>
                    <li class="nav-item">
